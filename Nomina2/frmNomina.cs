...
namespace Nomina2
{
    public partial class frmNomina : Form
    {
        ...
        private void importarExcelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                string excel = ofdExcel.FileName;
                CargarExcel(excel);
        ...
        private void tasasDePagoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (pago.IsDisposed)
            {
                ...
                {
                    datosJsonn valoresDefault = new datosJsonn(0.0, 0.0, 0.0);
                ...
                try
                {
                    ...
                    var registros = JsonConvert.DeserializeObject<datosJsonn>(json);
        ...
        private void cargarJson(datosJsonn datos)
        {
